    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Terms & Privacy</h2>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        ...
        <h2 className="text-2xl font-bold mb-4">Terms & Privacy</h2>
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CM Labs, 810 Seashore Road, NJ, 08204.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Raffle Leader, accessible from <a href="raffleleader.com" rel="external nofollow noopener" target="_blank">raffleleader.com</a></p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: stephen@raffleleader.com</li>
          </ul>
        </div>
      </Modal>
    </div>
